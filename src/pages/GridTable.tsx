...
import { ColumnProps, GridTableProps } from '../utils/interface';
            ...
            <td>
              {isCheckboxVisible && (
                <>
                  <input
                    type="checkbox"
                    onChange={(e) =>
                      handleParentCheckboxChange && handleParentCheckboxChange(rowIndex, e.target.checked, data, handleSelectCheckbox)
                    }
                    checked={
              ...
              {isShowChildrenGrid && (
                <button
                  ...
                  onClick={() => handleExpand && handleExpand(rowIndex)}
                >
                  <FontAwesomeIcon
                    icon={isRowExpanded && isRowExpanded(rowIndex) ? faMinus : faPlus}
                  />
                </button>
              )}
            </td>
                ...
                <tr key={childIndex}>
                  {isCheckboxVisible && (
                    <td key={childIndex}>
                      <input
                        type="checkbox"
                        onChange={(e) => handleCheckboxChange && handleCheckboxChange(e, rowIndex, child, data, handleSelectCheckbox)}
                        checked={
                          !!selectedChildData?.[rowIndex] &&
        ...
        <tr>
          {isCheckboxVisible && (
            <th>
              <input
                type="checkbox"
                onChange={() => handleSelectAll && handleSelectAll(data, handleSelectCheckbox)}
